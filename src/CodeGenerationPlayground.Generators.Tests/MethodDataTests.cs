...
public class MethodDataTests {
    ...
    public Task WriteSource() {
        ...
        var subject = new MethodData(new MethodOwnerData(new MethodOwnerData(null, "CodeGenerationPlayground.Generators.Tests", MethodOwnerType.Namespace), "MethodDataTests", MethodOwnerType.Class), "public", "WriteSource");
